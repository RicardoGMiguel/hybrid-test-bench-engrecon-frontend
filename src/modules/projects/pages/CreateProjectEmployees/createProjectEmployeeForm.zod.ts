...
const createProjectEmployeeFormSchema = z.object({
  selectedProjectEmployees: z
    .array(projectEmployee)
    .nonempty('A Lista de colaboradores é obrigatória'),
});

export type CreateProjectEmployeeFormData = z.infer<
  typeof createProjectEmployeeFormSchema
>;

export const createProjectEmployeeFormResolver = zodResolver(
  createProjectEmployeeFormSchema
);
